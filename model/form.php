...
?>
  <div class="container-fluid">
    ...
    <?php if ($msgupdate) : ?>
      <p><?= $msgupdate ?></p>
    <?php endif; ?>
    <div class="pole col-md-5 border border-1 border-dark rounded-top mt-5 mb-0 text-center" style="background-color:#2e4f9b;color:white;">
    ...
    <?php foreach ($posts as $post) : ?>
      <form action="" class="border d-flex " method="POST">
        ...
        <div class="col-md-1 text-md-end mt-2">
          <span class="role_absence-<?= $post['id'] ?>">
            <?php
            if ($post['role_absence'] == 0) {
              echo "Agent non autorisé";
            } else if ($post['role_absence'] == 1) {
              echo "Utilisateur";
            } else {
              echo "Admin";
            }
